  ...
  return (
    <>
      <h3 className="border font-serif tracking-[0.025rem] text-justify first-letter:float-left first-letter:mr-3 first-letter:text-7xl first-letter:font-bold first-letter:text-gray-900 first-line:tracking-widest first-line:uppercase m-1 p-4">
        ...
        crafted to make your language learning not just effective, but also
        exciting and memorable. Dive into challenges that sharpen your
        vocabulary, improve comprehension, and build confidence — all while
        staying connected to the cultural richness of Sanskrit. Whether you’re a
        beginner or advancing your fluency, this is the perfect place
      </h3>
    </>
  );
};

export default HomePageFinalContent;
